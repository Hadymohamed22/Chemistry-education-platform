...
function ThirdClass() {
  const videos = useSelector((store) => store.VideosClassThreeSlice);
  const navigate = useNavigate();
  return (
    <div className="third-class">
      <Hero
        mainText="الصف الثالث الثانوي"
        subText="لن تجعل الكيمياء معقدة بعد اليوم! تعلم بأسلوب مبسط يضمن لك النجاح الأكاديمي."
      />
      <div className="videos my-10">
        <div className="section-header font-extrabold text-5xl mb-12 text-center">
          شروحات <br /> <span>الصف الثاني الثانوي</span>
        </div>
